...
export default function Gallery() {
  return (
    <section className="px-4 py-16 font-oswald md:h-auto min-h-screen bg-black">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start mb-8 h-full">
        <div className="mb-8 md:mb-0 md:w-1/4 h-full flex flex-col">
          ...
          <p className="text-sm text-white dark:text-gray-300 max-w-md font-manrope mt-auto text-[20px]">
